                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-xl-3">
                                                ...
                                                <input class="form-control form-br" type="text" id="cutomer_fname"
                                                    name="cutomer_fname" onkeyup='saveValue(this);'
                                            ...
                                            <div class="col-lg-3 col-xl-3">
                                                ...
                                                <input class="form-control form-br" type="text" id="cutomer_lname"
                                                    name="cutomer_lname" onkeyup='saveValue(this);'
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xl-3">
                            ...
                            <input class="form-control form-br" type="text" id="store_name" name="store_name"
                                onkeyup='saveValue(this);' value="{{@$customerProfile->store_name}}"
                        ...
                        <div class="col-lg-3 col-xl-3">
                            ...
                            <select class="form-control form-br" id="customer_type" name="customer_type"
                                onchange='saveValue(this);' placeholder="Please select customer type">
                                <option value="">Please select customer type</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xl-12">
                            ...
                            <textarea class="form-control form-br" id="business_street_address"
                                name="business_street_address" placeholder="Please enter address"
        ...
        <table class="table">
            ...
            ?>
                <tr class="odd gradeX">
                    ...
                    <td><input type="text" name="business_gst_number" id="business_gst_number" class="docnumber-group form-control">
                    </td>
                ...
                <img src="https://dev.bartan.com/assets/img/user/user-4.jpg" class="img-rounded height-30" /></div></td> -->
                    <td><input type="file" name="gst_certificate" id="gst_certificate"
                            class="docsValidation form-control certificateDocValidate" data-toggle="tooltip" data-placement="top"
                ...
                <tr class="even gradeC">
                    ...
                    <td><input type="text" name="pan_number" id="pan_number" class="form-control docnumber-group"></td>

                    <td>
                        <input type="file" name="FSSAI_certificate"  id="FSSAI_certificate" class="docsValidation form-control certificateDocValidate" data-toggle="tooltip" data-placement="top"
                ...
                <tr class="odd gradeX">
                    ...
                    <td><input type="text" name="adhar_number" id="adhar_number" class="form-control docnumber-group"></td>

                    <td>
                        <input type="file" name="adhar_card"  id="adhar_card" class="docsValidation form-control certificateDocValidate" data-toggle="tooltip" data-placement="top"
                            title="(png,jpg,jpeg,pdf,Max. Size 5MB)">
                    </td>
                ...
                <tr class="even gradeC">
                    ...
                    <td><input type="text" name="cancel_check" id="cancel_check" class="form-control docnumber-group"></td>

                    <td>
                        <input type="file" name="cancel_bank_cheque" id="cancel_bank_cheque" class="docsValidation form-control certificateDocValidate" data-toggle="tooltip" data-placement="top"
                            title="(png,jpg,jpeg,pdf,Max. Size 5MB)">
