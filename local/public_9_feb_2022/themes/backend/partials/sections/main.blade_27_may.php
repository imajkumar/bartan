        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">CREATE YOUR SUBHIKSH PROFILE</h4>
                                            ...
                                            <div>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                             <label class="text-lg-right col-form-label" for="document_option">Statutory Document <span class="required-star">* </span>
 </span></label>
                                        ...
                                        <fieldset>
                                            ...
                                            <div>
                                                ...
                                                ?>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                            <label class="text-lg-right col-form-label">GST Certificate <span class="required-star">* (Max. Size 5MB)</span></label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                              <label class="text-lg-right col-form-label">Shop establishment license<span class="required-star">(Max. Size 5MB)</span></label>
                                                    ...
                                                    {{-- <div class="form-group row m-b-10">
                                                        <label class="col-lg-3 text-lg-right col-form-label">Shop establishment license <span class="required-star">(Max. Size 5MB)</span></label>
                                                        <div class="col-lg-9 col-xl-6">
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                              <label class="text-lg-right col-form-label">Trade certificate <span class="required-star">* (Max. Size 5MB)</span></label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                               <label class="text-lg-right col-form-label">PAN Copy <span class="required-star">* (Max. Size 5MB)</span></label>
                                                            <input type="file" name="FSSAI_certificate"  class="docsValidation form-control form-br" placeholder="Please upload FSSAI certificate"/>
                                                            <input type="hidden" name="FSSAI_certificate_old"  value="{{@$customerProfile->FSSAI_certificate}}"/>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                              <label class="text-lg-right col-form-label">Driving License <span class="required-star">* (Max. Size 5MB)</span></label>
                                                            <input type="file" name="driving_license"  class="docsValidation form-control form-br" placeholder="Please upload driving license"/>
                                                            <input type="hidden" name="driving_license_old"  value="{{@$customerProfile->driving_license}}"/>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                              <label class="text-lg-right col-form-label">Cancelled Bank Cheque <span class="required-star">* (Max. Size 5MB)</span></label>
                                                            <input type="file" name="cancel_bank_cheque"  class="docsValidation form-control form-br" placeholder="Please upload cancel bank cheque"/>
                                                            <input type="hidden" name="cancel_bank_cheque_old"  value="{{@$customerProfile->cancel_bank_cheque}}"/>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                              <label class="text-lg-right col-form-label">Dealer Photo <span class="required-star">* (Max. Size 5MB)</span></label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                              <label class="text-lg-right col-form-label">Other document <span class="required-star">* (Max. Size 5MB)</span></label>
