                ...
                <table class="table table-invoice">
                        ...
                        $sumQty=0;
							...
							//Tax
                               ...
                               //echo @$AfterDiscountPrice;exit;
								...
								$itemQTY = $itemOrder->quantity;
								
								$taxArrData = getTaxAppliedByProductID(@$itemOrders[0]->customer_id, $itemOrder->item_id, $itemOrder->quantity);
                    ...
                    <tr>
                        ...
                        <td class="cart-summary" colspan="10">
                                    ...
                                    <p style="font-size: 1.1rem;"><strong> <?php @$InWord = numberTowords(round(@$TotalGrandTotal));?>{{@$InWord}} only</strong></p>
