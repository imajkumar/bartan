                                    ...
                                    foreach ($dataObjArr as $itemData) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-default" href="{{route('itemEditLayout',$itemData->item_id)}}" target="_blank" data-toggle="tooltip" data-container="body" data-title="Edit"><i class="far fa-lg fa-fw fa-edit"></i></a>
                                            </td>
                                        </tr>
