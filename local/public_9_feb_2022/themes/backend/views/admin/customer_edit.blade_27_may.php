                                    ...
                                    <div id="step-5">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group row m-b-10">
                                                    <label class="col-lg-3 text-lg-right col-form-label">PAN Copy</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                ...
                                                <div class="form-group row m-b-10">
                                                    <label class="col-lg-3 text-lg-right col-form-label">Driving license</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                ...
                                                <div class="form-group row m-b-10">
                                                    <label class="col-lg-3 text-lg-right col-form-label">Cancel bank cheque</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                ...
                                                <div class="form-group row m-b-10">
                                                    <label class="col-lg-3 text-lg-right col-form-label">Dealer photo</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                ...
                                                <div class="form-group row m-b-10">
                                                    <label class="col-lg-3 text-lg-right col-form-label">Other document</label>
                                                    <div class="col-lg-9 col-xl-6">
