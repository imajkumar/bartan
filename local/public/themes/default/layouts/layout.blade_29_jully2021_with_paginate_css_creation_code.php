...
<style>
<?php for($n=82; $n<=1000; $n++){ ?>
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n-2}}):not(:first-child):not(:nth-child(2)) {
...
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n-2}}):not(:first-child):not(:nth-child(2)):after {
  content: "...";
  color: #fff;
  font-size: 32px;
  margin-left: -6px;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n-1}}):not(:first-child) {
  display: inline-block;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n-2}}):not(:first-child) {
  display: inline-block;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child(({{$n+1}}) {
  background-color: #000;
  color: #fff;
  display: inline-block;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n+1}}) + .cdp_i:last-child {
  display: none !important;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n+2}}):not(:last-child) {
  display: inline-block;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n+3}}):not(:last-child) {
  display: inline-block;
}
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n+4}}):not(:last-child):not(:nth-last-child(2)) {
  display: inline-block;
  pointer-events: none;
  color: transparent;
  border-color: transparent;
...
.cdp[actpage="{{$n}}"] .cdp_i:nth-child({{$n+4}}):not(:last-child):not(:nth-last-child(2)):after {
  content: "...";
  color: #fff;
  font-size: 32px;
  margin-left: -6px;
