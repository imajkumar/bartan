                ...
                <table class="table table-invoice">
                    ...
                    <tbody class="">
                        <tr>
                            ...
                            <!-- <td class="value"><a href="#allItemByOrderProccessModel" id="{{$itemOrders[0]->order_id}}"  onclick="allItemByOrderProccessModel(this.id);" data-toggle="modal">{{count($itemOrders)}}</a></td> -->
                            <td class="value"><a href="#allItemByOrderProccessModel" id="{{$itemOrders[0]->order_id}}"
                                    onclick="allItemByOrderProccessModel(this.id);"
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control m-b-5" value="{{$itemOrders[0]->order_id}}"
                        placeholder="Order No" disabled="" readonly>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control m-b-5"
                        value="{{date('d-m-Y',strtotime($itemOrders[0]->created_at))}}" placeholder="12/02/2020"
                        disabled="" readonly>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control m-b-5" placeholder="Packing date"
                        value="{{date('d-m-Y', strtotime($itemOrders[0]->created_at))}}" disabled="" readonly>
                        ...
                        <table class="table table-invoice my-custom-scrollbar table-wrapper-scroll-y">
                            <thead>
                                <tr>
                                    ...
                                    <th class="field">Actual weight</th>
                                    <th class="field">Calculation weight</th>
                    ...
                    foreach($toBePackedScanItems as $item){
                        if($item->is_packed !=1){
                            ...
                            $itemOrder = DB::table('tbl_item_orders')
                                    ...
                                    ->where('order_id', $item->order_number)
                                    ->first();
                        ...
                        $itemImages = get_item_default_img_item_id($item->item_id);
                            ...
                            if(@$itemOrder->item_weight_in_kg != 0 && @$itemOrder->set_of_in_weight != 0 && @$itemOrder->price_per_kg != 0){
                                if($itemOrder->pending_qty !=0){

                                    @$itemActualWeightKg = ($itemOrder->item_weight_in_kg * $itemOrder->set_of_in_weight) * $itemOrder->pending_qty; 
                                }else{
                        
                                    @$itemActualWeightKg = ($itemOrder->item_weight_in_kg * $itemOrder->set_of_in_weight) * $itemOrder->quantity; 
                                }
                            }
                    ?>
                                <tr>
                                    ...
                                    <td class="value">{{preg_replace("/[^0-9.]/", "", $itemActualWeightKg )}}</td>
                                    <td class="value">{{@$item->calculation_weight}}</td>
                                    <td class="value"><a href="javascript::void(0);"
                                            id="{{@$itemOrders[0]->order_id.'_'.$item->item_id.'_'.$item->customer_id.'_'.$item->id}}"
                                            onclick="deleteScandItem(this.id);" class="btn btn-danger"
                                            data-toggle="tooltip" data-container="body" data-title="Dalete"><i
...
?>
                                    @csrf
                                    <input type="hidden" class="form-control m-b-5" name="order_number"
                                        value="{{@$itemOrders[0]->order_id}}" />
...
<input type="hidden" class="form-control m-b-5"  name="item_id" value="3"/> -->
                                    <input type="hidden" class="form-control m-b-5" name="customer_id"
                                        value="{{@$itemOrders[0]->customer_id}}" />
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-4">Small Box</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control m-b-5 countTotalPackingDetailBox"
                                                name="small_box" id="small_box"
                                                value="{{@$itemOrderPackingDetail->small_box}}"
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control m-b-5 countTotalPackingDetailBox"
                                                name="medium_box" id="medium_box"
                                                value="{{@$itemOrderPackingDetail->medium_box}}"
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control m-b-5 countTotalPackingDetailBox"
                                                name="large_box" id="large_box"
                                                value="{{@$itemOrderPackingDetail->large_box}}"
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control m-b-5 countTotalPackingDetailBox"
                                                name="bori" id="bori" value="{{@$itemOrderPackingDetail->bori}}"
                                                placeholder="Bori" />
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control m-b-5 countTotalPackingDetailBox"
                                                name="other" id="other" value="{{@$itemOrderPackingDetail->other}}"
                                                placeholder="Other" />
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control m-b-5 total" name="total" id="total"
                                                value="{{@$itemOrderPackingDetail->total}}" placeholder="Total"
                                                disabled="" />
                                            <input type="text" class="form-control m-b-5 total" name="total"
                                                value="{{@$itemOrderPackingDetail->total}}" placeholder="Total"
                                                style="display:none" />
        ...
        <div class="row">
            <div class="col-6">
                <button type="button" onclick="printLableAndSaveBox();"
                    class="btn btn-success btn-block m-b-5  mt-5">Print Lable </button>
            </div>

            <div class="col-6">
                <button class="btn btn-success btn-block m-b-5  mt-5" id="packedBtnProcess"
                    onclick="moveToshipingBtn();">Packed</button>
...
<div class="modal  popdgn" id="allItemByOrderProccessModel">
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-invoice">
                                ...
                                <tbody id="allItemByOrderProccessOnModelAppend"></tbody>
                            </table>
