                                ...
                                <form method="post" action="{{route('saveItem')}}" class="form-horizontal" id="saveItemMaster" data-parsley-validate="true" name="saveItemMaster">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-8">
                                            ...
                                            <div class="form-group row m-b-15">
                                                <label class="col-md-12 col-sm-4 col-form-label" for="itemBarcode">Barcode <span class="required-star">* </span>:</label>
                                                <div class="col-md-12 col-sm-8">
                                                   <input type="text" class="form-control itemBarcode" name="barcode" id="0" maxlength="13">
