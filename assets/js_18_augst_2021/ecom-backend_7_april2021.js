...
$(document).ready(function() {
    ...
    $("#saveCustomerProfileDetails").validate({
        ...
        messages: {
            pan_number: "Please fill name pan",
    ...
    $("#wizard").on("leaveStep", function(e, anchorObject, currentStepIndex, nextStepIndex, stepDirection) {
        ...
        if (currentStepIndex == 2 && nextStepIndex == 'forward') {
            ...
            var gst_certificate_old = $("#gst_certificate").val();
            //alert(gst_certificate_old);
            var checkValidationCert = false;
            $('#sgst_certificate_errorMsg').remove();
            if (gst_certificate_old == "") {

                $('#gst_certificate_old').after('<div id="sgst_certificate_errorMsg" class="error">Please choose gst certificate.</div>');

                // $('.sw-btn-next').addClass('disabled');
                // $('.sw-btn-next').attr('disabled', true);
                checkValidationCert = true;
                return false;
            }
        ...
        if (currentStepIndex == 1 && nextStepIndex == 'forward') {
            //$('.sw-btn-next').on('hover', function() {

            var store_name = $("#store_name").val();
            var customer_type = $("#customer_type").val();
            var business_street_address = $("#business_street_address").val();
            ...
            var business_gst_number = $("#business_gst_number").val();

            // var pan_number = $("#pan_number").val();
            // var dl_number = $("#dl_number").val();
            // var cancel_check = $("#cancel_check").val();

            // var check =false;
            // if(business_gst_number == '' || pan_number == ''){
            //     check = true;
            // }else if(business_gst_number == '' || dl_number == ''){
            //     check = true;
            // }else if(business_gst_number == '' || cancel_check == ''){
            //     check = true;
            // }else if(pan_number == '' || dl_number == ''){
            //     check = true;
            // }else if(pan_number == '' || cancel_check == ''){
            //     check = true;
            // }else if(dl_number == '' || cancel_check == ''){
            //     check = true;
            // }else{
            //     check =false;
            // }
            ...
            $('#business_gst_number_lenth_errorMsg').remove();


            // if ($("#saveCustomerProfileDetails").valid()) {
            //     checkValidation = true;
            // }

            if (store_name == "") {

                $('#store_name').after('<div id="store_name_errorMsg" class="error">Please fill your First Name.</div>');
            ...
            if (customer_type == "") {
                $('#customer_type').after('<div id="customer_type_errorMsg" class="error">Please fill your Last Name.</div>');
                checkValidation = true;
            }
            if (business_street_address == "") {
                $('#business_street_address').after('<div id="business_street_address_errorMsg" class="error">Please fill your Valid Mobile Number.</div>');
                checkValidation = true;
            }
            if (business_country == "") {
                $('#business_country').after('<div id="business_country_errorMsg" class="error">Please fill your Email id.</div>');
                checkValidation = true;
            }
            if (business_state == "") {
                $('#business_state').after('<div id="business_state_errorMsg" class="error">Please fill your Email id.</div>');
                checkValidation = true;
            }
            if (business_city == "") {
                $('#business_city').after('<div id="business_city_errorMsg" class="error">Please fill your Email id.</div>');
                checkValidation = true;
            }
            if (business_postal_code == "") {
                $('#business_postal_code').after('<div id="business_postal_code_errorMsg" class="error">Please fill your Email id.</div>');
                checkValidation = true;
            }
            if (business_gst_number == "") {
                $('#business_gst_number').after('<div id="business_gst_number_errorMsg" class="error">Please fill your Email id.</div>');
                checkValidation = true;
            }

            if (business_gst_number.length > 15) {
                $('#business_gst_number').after('<div id="business_gst_number_lenth_errorMsg" class="error">Fill your Valid GSTNO.</div>');
                checkValidation = true;
            }
            ...
            if (checkValidation) {
                ...
                $('#business_gst_number_lenth_errorMsg').html(' ');
