                            ...
                            <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                                ...
                                <tbody>
                                    <?php
                                     ...
                                     foreach($itemOrders as $itemOrder){
                                        ...
                                        if($itemOrder->packing_stage != 6){
                                            ...
                                            ->where('order_number', $itemOrder->order_number)
                                            ->where('customer_id', $itemOrder->customer_id)
                                            ->where('packing_no', $itemOrder->packing_no)
                                            ->where('item_id', $itemOrder->item_id)
                                            ->first();
                                            if(empty($checkShipedOrderExists)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        {{date("d-m-Y h:i a", strtoTime(@$itemOrder->createdAt))}}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('tobeShipedOrder', $itemOrder->packing_no)}}" id="{{$itemOrder->order_id.'_'.$itemOrder->stage}}" class="btn btn-default" data-toggle="tooltip" data-container="body" data-title="Edit"><i class="far fa-lg fa-fw fa-edit"></i></a>
                                                ...
                                                <a href="{{route('viewPackedOrderAdmin', $itemOrder->packing_no)}}" class="btn btn-success"><i class="fas fa-lg fa-fw fa-eye"></i>View</a>
