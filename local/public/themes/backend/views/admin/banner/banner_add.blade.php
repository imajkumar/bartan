                                ...
                                <div class="col-md-3 col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-8">
                                            <input type="file" class="form-control @error('banner') is-invalid @enderror" accept="image/*" onchange="loadFile(event)" id="banner"  name="banner" placeholder="Required" data-parsley-required="true">
                                            
                                            
                                        </div>
                                         <div class="col-sm-12">
                                            <small class="impsize">File Size: Widht: 1600px, Height: 423px</small>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-8">
                                            <input type="file" class="form-control @error('mobile_view_banner') is-invalid @enderror" accept="image/*"  id="mobile_view_banner" name="mobile_view_banner" placeholder="Required" data-parsley-required="true">
                                            
                                            
                                        </div>
                                        <div class="col-sm-12">
                                            <small class="impsize">File Size: Widht: 750, Height: 400px</small>
                                        </div>
