...
<div class="search-container hello">
            ...
            <div class="search-content">
                ...
                <div class="search-item-container">
						...
						<div class="item item-thumbnail">
							...
							<div class="item-info">
                                ...
                                <?php }else{ ?>
                                    ...
                                    <div class="item-price itm-dpr"> MRP: <span>₹{{($item->item_mrp)? $item->item_mrp:0}}</span></div>
					...
					<?php  $i++;}}}else{?>
                        <div class="item-nofound item-row"><h4><i class="fas fa-shopping-basket"></i>Item not found</h4></div>
                        <?php }?>
