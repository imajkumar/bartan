...
<?php if(Session::has('warning')){?>
  <div class="col-lg-12">
    <div class="tnk text-center">
      ...
      <h1>Thank you!</h1>
      <p class="alert-danger">{{ Session::get('warning') }}</p>
    </div>
  </div>
  ...
  <div class="col-lg-12">
    <div class="tnk none text-center">
...
@$paymentInfo = json_decode(@$itemOrders[0]->payment_gateway_info);
if(!empty($paymentInfo)){
  
  @$exportName=explode("=", @$paymentInfo[11]);
  @$exportTracking_id=explode("=", @$paymentInfo[1]);
  @$exportPayment_mode=explode("=", @$paymentInfo[5]);
  @$exportBilling_tel=explode("=", @$paymentInfo[17]);
  @$exportBilling_email=explode("=", @$paymentInfo[18]);
  @$exportAmount=explode("=", @$paymentInfo[10]);
  ...
  <div class="col-lg-6 mx-auto">
      <div class="checkout"> 
          <table class="table ptmtbl ">
            ...
            <tr>
              <td>Payment Mode.</td>
              <td class="text-right">{{@end($exportPayment_mode)}}</td>
            </tr>
            <tr>
              <td>Mobile</td>
              <td class="text-right">{{@end($exportBilling_tel)}}</td>
            </tr>
            <tr>
              <td>Email ID</td>
              <td class="text-right">{{@end($exportBilling_email)}}</td>
            </tr>
            <tr>
              <td><strong>Amount</strong></td>
              <td class="text-right"><strong>{{@end($exportAmount)}}</strong></td>
            </tr>
                <td>Transaction ID</td>
                <td class="text-right">{{@end($exportTracking_id)}}</td>
...
<div class="checkout-body"> 
 ...
 --> 
          ...
          <table class="table table-invoice">
            <thead>
              <tr> 
                ...
                <th class="field" width="30px">Item Name</th>
            ...
            <tbody>
              ...
              $sumQty=0;
                        foreach($itemOrders as $item)
                        {
                            ...
                            @$productArrForHsn = DB::table('tbl_items')->where('item_id', $item->item_id)->select('hsn_code')->first();
              ...
              <tr>
                ...
                <td class="value">{{optional($item)->quantity}}

                          <br/><br/>{{(optional($item)->set_of > 0)? '('.optional($item)->set_of.' Pcs)':''}}
                </td>
                <td class="value">
                  {{optional($item)->unit}}
                @if(@$item->price_per_kg)
                    (Price per kg:<span class="price-pr-kg">{{@$item->price_per_kg}}</span>)
                @endif
                </td>
              ...
              <tr>
                ...
                <td class="cart-price text-center">Packaging Charges</td>
              ...
              <tr>
                <td class="cart-price"> </td>
                <td class="cart-price text-center">Delivery Charge</td>
                <td class="cart-price text-center"></td>
                <td class="cart-price text-center"></td>
                <td class="cart-price text-center"></td>
              ...
              <tr>
                ...
                <td class="cart-summary" colspan="2"><div class="summary-container wth">
    ...
    <p class="text-silver-darker text-center m-b-0">Should you require any assistance, you can get in touch with Support Team at 9821067414</p>
  </div>
