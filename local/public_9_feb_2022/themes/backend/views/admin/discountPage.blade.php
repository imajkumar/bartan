                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="100" oninput="this.value = Math.abs(this.value)" class="form-control" name="discount_percentage" id="discount_percentage">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" min="<?= date('Y-m-d'); ?>" class="form-control" name="applicable_from" id="applicable_from">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" min="<?= date('Y-m-d'); ?>" class="form-control" name="expired_on" id="expired_on">
