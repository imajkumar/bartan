        ...
        <div class="col-xl-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="default-tab-1">
                    ...
                    <form action="{{route('saveChangesProductDetailsSales')}}" method="post" id="ajaxProductAttrSaveEditNeerajSales">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label >Barcode</label>
                                    <input type="text" class="form-control" name="barcode" id="itemBarcode" maxlength="13" value="{{optional($item)->barcode}}">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label >SKU</label>
                                    <input type="text" readonly class="form-control" name="item_sku" value="{{$sku}}"  placeholder="SKU">
                                </div>
 ...
 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{optional($item)->regular_price}}" name="regular_price" class="form-control"  placeholder="">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label >Length</label>
                                    <input type="text" value="{{optional($item)->item_invt_lengh}}" class="form-control" name="item_invt_lengh">
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label >Width</label>
                                    <input type="text" class="form-control" value="{{optional($item)->item_invt_width}}" name="item_invt_width">
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{optional($item)->item_invt_height}}" name="item_invt_height">
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="{{optional($item)->item_invt_height}}" placeholder="" name="item_invt_height">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_invt_weight" value="{{optional($item)->item_invt_weight}}" class="form-control"  placeholder="">
                ...
                <div class="tab-pane fade" id="default-tab-2" style="padding:10px;background-color: #b6c2c9;">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show" id="default-tab-1A">
                            ...
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <button type="button" style="margin-top: 27px;" id="{{$rowData->id}}" onclick="deleteItemAttrOptionSales(this.id)" class="btn btn-sm btn-danger m-r-5 remove_field_Attr"> DELETE</button>
                                        </div>
                                    </div>
                                <?php
                                }
                        ...
                        <div class="tab-pane fade" id="default-tab-2A">
                            <!-- attr setting  -->
                            <form class="form-horizontal" data-parsley-validate="true" method="post" action="{{route('saveChangesProductAttribueSales')}}" id="saveItemCategoryeditProductSales" name="saveItemCategoryeditProductSales">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectProductAttributeSales" id="selectProduct" name="selectProductCatID" placeholder="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control productAttribute" id="productAttributeSales" name="productAttributeID" placeholder="Please select attribute">
                                                <option value="">-SELECT-</option>
                                                <?php 
                                                $catAttrChildArr = DB::table('tbl_item_category_child')->where('item_category_id', $item->cat_id)->get();
       
                                                    foreach ($catAttrChildArr as $key => $rowData) {
                                                        $catAttrChildArr = DB::table('tbl_attributes')->where('id', $rowData->item_attr_id)->first();
                                                        
                                                    ?>
                                                     <option value="{{@$rowData->item_attr_id}}">{{@$catAttrChildArr->admin_name_lable}}</option>
                ...
                <div class="tab-pane fade" id="default-tab-4">
                    ...
                    <form class="form-horizontal" data-parsley-validate="true" method="post" action="{{route('saveChangesProductRelationSales')}}" id="saveChangesProductRelationSales" name="saveItemCategoryeditProductSales">
                ...
                <div class="tab-pane fade" id="default-tab-5">
                    ...
                    <form class="form-horizontal" data-parsley-validate="true" method="post" action="{{route('saveChangesProductTaxationSales')}}" id="saveChangesProductTaxationSales" name="saveChangesProductTaxationSales">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="hsn_code">
                                        ...
                                        ?>
                                            <option value="{{$hsnData->id}}">{{$hsnData->hsn_name}}</option>                                      
                                        <?php }?>
                                    </select>
                                </div>
