                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-xl-3" id="panNumber" style="display:none">
                                                            ...
                                                            <label class="text-lg-right col-form-label removeField"> PAN </label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3" id="gstNumber" style="display:none">
                                                            ...
                                                            <label class="text-lg-right col-form-label removeField"> GSTIN </label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3" id="dlNumber" style="display:none">
                                                            ...
                                                            <label class="text-lg-right col-form-label removeField"> Driving License </label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3" id="cancelCheck" style="display:none">
                                                            ...
                                                            <label class="text-lg-right col-form-label removeField"> Cancel Check </label>
                                        ...
                                        <fieldset>
                                            ...
                                            <div>
                                                ...
                                                ?>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                            <label class="text-lg-right col-form-label">GST Certificate <span class="required-star">* </span></label>
                                                    ...
                                                    {{-- <div class="form-group row m-b-10">
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                             <label class="text-lg-right col-form-label">MSME Registration/Udyog Adhaar</label>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                               <label class="text-lg-right col-form-label">FSSAI certificate</label>
