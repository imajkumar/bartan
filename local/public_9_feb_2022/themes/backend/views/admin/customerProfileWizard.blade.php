              ...
              <div class="coming-soon-header">
                  ...
                  <div class="brand">
                      ...
                      ?>
                            ...
                            <b>Please contact to admin, Your account id deactivated.</b> 

                        <?php } else {?>

                            <b>Congratulation your profile aprroved from admin</b>
          ...
          <div class="coming-soon">
              ...
              <div class="coming-soon-header">
                  ...
                  <div class="brand">
                      ...
                      <span>Wait Your KYC is pending from admin</span>
                  </div>
                  <div class="desc">
                    <a href="{{url('/')}}" class="btn btn-primary">CONTINUE SHOPPING</a>
                      {{-- You are register successfully, Please wait admin approvel. --}}
