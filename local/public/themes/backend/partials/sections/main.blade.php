        ...
        <table class="table">
            ...
            ?>
                ...
                <tr class="even gradeC">
                    ...
                    <td>
                        <input class="form-control docnumber-group" type="text" name="dl_number" id="dl_number" onkeyup="saveValue(this);" placeholder="">
                        
                    </td>

                    <td>
                        <input type="file" name="driving_license" id="driving_license" class="docsValidation certificateDocValidate" data-toggle="tooltip" data-placement="top"
                            title="(png,jpg,jpeg,pdf,Max. Size 5MB)">
                ...
                <tr class="even gradeC" hidden>
                    <td>5</td>
                    <td><strong>Cancel Cheque</strong></td>
                    <td><input type="text" name="cancel_check" id="cancel_check" onkeyup="saveValue(this);" class="form-control"></td>

                    <td>
                        <input type="file" name="cancel_bank_cheque" id="cancel_bank_cheque" class="docsValidation" data-toggle="tooltip" data-placement="top"
                            title="(png,jpg,jpeg,pdf,Max. Size 5MB)">
                            <input type="hidden" name="cancel_bank_cheque_old" id="cancel_bank_cheque_old" value="{{@$customerProfile->cancel_bank_cheque}}"/>
                    </td>
