                    ...
                    <div class="tab-pane fade active show" id="product-desc">
                        ...
                        <div class="product-purchase-container">
                            ...
                            <div class="product-price">
                                ...
                                if($totalOff == 0){
                                ?>
                                    <div class="price itm-pr"> Offer Price:₹{{($item->regular_price)? $item->regular_price:0}}</div>
                                    @if($item->item_mrp)
                                    <div class="product-discount">
                                        <span class="discount itm-dpr"> MRP: <span>₹{{($item->item_mrp)? $item->item_mrp:''}}</span>
                                    </div> 
                                ...
                                <?php }else{ ?>
                                    ...
                                    <div class="product-discount">
                                        <span class="discount itm-dpr"> MRP: <span>₹{{($item->regular_price)? $item->regular_price:0}}</span>
                                    </div> 
                        ...
                        <div class="item-info">
                            ...
                            <?php 
                                if($totalOff == 0){
									...
									<div class="item-discount-price">₹{{($product_up_sale->item_mrp)? $product_up_sale->item_mrp:''}}</div>
									@endif
                    ...
                    <div class="item-info">
                        ...
                        <?php 
                                if($totalOff == 0){
									...
									<div class="item-discount-price">₹{{($product_cross_sale->item_mrp)? $product_cross_sale->item_mrp:''}}</div>
									@endif
