                    ...
                    <table id="data-table-scroller" class="table table-striped table-bordered  table-td-valign-middle"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-nowrap">Iteam</th>
                                <th class="text-nowrap">Iteam Name</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-4">Shiping Cost</label>

                                        <div class="col-md-8">
                                            <input type="text" name="shiping_cost" id="shiping_cost" class="form-control m-b-5" placeholder="Shiping Cost" />
