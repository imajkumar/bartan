                                                ...
                                                <div class="row">
                                                    <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Your Business info, so that you can easily attach we</legend>
                                                        ...
                                                        <div class="col-lg-3 col-xl-3">
                                                            ...
                                                            <textarea class="form-control form-br" type="text" id="business_street_address" name="business_street_address" value="{{@$customerProfile->business_street_address}}" placeholder="Please enter address" data-parsley-required="true"></textarea>
                                                        </div>
        ...
        <table class="table">
            ...
            ?>
                <tr class="odd gradeX">
                    ...
                    <td><input type="text" name="business_gst_number" id="business_gst_number" value="{{@$customerProfile->business_gst_number}}" class="form-control">
                    </td>
                ...
                <tr class="even gradeC">
                    ...
                    <td><input type="text" name="pan_number" id="pan_number" value="{{@$customerProfile->pan_number}}" class="form-control"></td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><input type="text" name="adhar_number" id="adhar_number" value="{{@$customerProfile->adhar_number}}" class="form-control"></td>
                ...
                <tr class="even gradeC">
                    ...
                    <td><input type="text" name="cancel_check" id="cancel_check" value="{{@$customerProfile->cancel_check}}" class="form-control"></td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><input type="text" name="shop_establishment_number" id="shop_establishment_number" value="{{@$customerProfile->shop_establishment_number}}" class="form-control"></td>
                ...
                <tr class="even gradeC">
                    ...
                    <td><input type="text" name="Trade_certificate_number" id="Trade_certificate_number" value="{{@$customerProfile->Trade_certificate_number}}" class="form-control"></td>
