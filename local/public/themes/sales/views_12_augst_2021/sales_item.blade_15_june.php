...
<div id="search-results" class="content">
    ...
    <div class="form-group row m-b-15 pull-right">
                                <label class="col-md-12 col-sm-4 col-form-label" for="">Customer</label>
                                <div class="col-md-12 col-sm-6">
                                    <select class="form-control" id="selesCustomer" name="selesCustomer" placeholder="Please select customer">
                                        ...
                                        <?php
                                            ...
                                            //pr($selesCustome);
                                        ?>
                                            <option value="{{$selesCustome->id}}" {{(@$customer->id == $selesCustome->id)? 'selected':''}}>{{ucfirst($selesCustome->cutomer_fname.' '.$selesCustome->cutomer_lname )}}</option>
        ...
        <div class="row" id="filtterItem" style="display:{{($customer)? '':'none'}}">
            <div class="col-md-4">
            <label class="col-md-12 col-sm-4 col-form-label" for="">By Brand</label>
                <div class="input-group">
                   
                    <select class="form-control" id="salesItemByBrand" name="salesItemByBrand">
                        <option value="">Select brand</option>
                        <?php
                            $brandsListArr = DB::table('tbl_brands')->get();
                        ?>
                        @foreach($brandsListArr as $brandsList)
                            <option value="{{$brandsList->id}}">{{ucwords($brandsList->name)}}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-4">
            <label class="col-md-12 col-sm-4 col-form-label" for="">By Category</label>
                <div class="input-group">
                    <select class="form-control" id="salesItemByCategory" name="salesItemByCategory">
            ...
            <label class="col-md-12 col-sm-4 col-form-label" for="">Search</label>
                <div class="input-group">
                    <input type="text" id="salesItemSeach" name="salesItemSeach" onkeyup="searchItemBySales()" placeholder="Search" class="form-control bg-silver-lighter">
