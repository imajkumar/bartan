...
<div style="margin-top:10px;"<strong style="font-size: 12px">{{($name)? 'Hello '.ucfirst($name):'Dear Customer,'}},</strong>
<p style="font-size: 16px; margin: 15px 0px 10px 0px;"><strong>Your One Time Password (OTP) to login to your Subhiksh account is. {{$otp}} </strong></p>
