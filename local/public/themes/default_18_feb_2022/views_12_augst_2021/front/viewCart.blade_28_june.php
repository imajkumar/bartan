                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="checkout-headerbtn">
                            <a href="" data-toggle="tooltip" data-placement="top" title="Download"><i class="fas fa-download"></i></a>
                            <a href="" data-toggle="tooltip" data-placement="top" title="Print"><i class="fas fa-print"></i></a>
                        </div>
                    ...
                    <table class="table table-cart">
                        ...
                        <tbody>
                           ...
                           //pr($cartCollection );
                            ...
                            <input type="hidden" name="deliveryChargRate" value="{{$deliveryChargRate}}" />
                            <input type="hidden" name="deliveryChargDiscount" value="{{$deliveryChargDiscount}}" />
                            <input type="hidden" name="deliveryChargNetRate" value="{{$deliveryChargNetRate}}" />
                            <input type="hidden" name="deliveryChargBasic" value="{{$deliveryChargBasic}}" />
                            <input type="hidden" name="deliveryChargCGST" value="{{$deliveryChargCGST}}" />
                            <input type="hidden" name="deliveryChargSGST" value="{{$deliveryChargSGST}}" />
                            <input type="hidden" name="deliveryChargIGST" value="{{$deliveryChargIGST}}" />
                            <input type="hidden" name="deliveryChargAmount" value="{{$deliveryChargAmount}}" />
                            
                            <input type="hidden" name="packingChargRate" value="{{$packingChargRate}}" />
                            <input type="hidden" name="packingChargDiscount" value="{{$packingChargDiscount}}" />
                            <input type="hidden" name="packingChargNetRate" value="{{$packingChargNetRate}}" />
                            <input type="hidden" name="packingChargBasic" value="{{$packingChargBasic}}" />
                            <input type="hidden" name="packingChargCGST" value="{{$packingChargCGST}}" />
                            <input type="hidden" name="packingChargSGST" value="{{$packingChargSGST}}" />
                            <input type="hidden" name="packingChargIGST" value="{{$packingChargIGST}}" />
                            <input type="hidden" name="packingChargAmount" value="{{$packingChargAmount}}" />
