        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="tree-view-1">
                <div class="panel-heading">
                    <h4 class="panel-title">DELIVERED ORDERS POINTS</h4>
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Earn point</th>                                      
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('viewDeliveredOrderAdmin', $itemOrder->shiping_no)}}" class="btn btn-success"><i class="fas fa-lg fa-fw fa-eye"></i>View</a>
                                            
                                            <a href="#updateDeliveredOrderPaymentStatusAdminModel" id="{{$itemOrder->order_number.'_'.$itemOrder->order_stage.'_'.$itemOrder->shiping_no.'_'.$itemOrder->packing_no}}" onclick="updateDeliveredOrderPaymentStatus(this.id);" class="updateDeliveredOrderPaymentStatusAdminModel btn btn-success" data-toggle="modal">Change payment</a>
                                        </td>
                                        <!-- <td>
