               ...
               <!--  <div class="col-xl-4 col-md-4">
                ...
                <div class="col-xl-12 col-md-8">
                    ...
                    <table class="table table-invoice">
                     ...
                     <form id="barcodeScanForm" method="post" action="{{route('barcodeScanItemUpdate')}}">
                ...
                <input type="hidden" name="scanItemRowId" id="scanItemRowId" />
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="col-form-label">Actual Weight In Kg</label>
                            <input type="text" class="form-control m-b-5" name="item_invt_weight" id="item_invt_weight"
                                placeholder="Item Weight" readonly>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="col-form-label">As per calculation weight In Kg</label>
                            <input type="text" class="form-control m-b-5" name="calculation_weight" id="calculation_weight"
                                placeholder="Calculation Weight" >
             ...
             <div class="invoice-content">
                            ...
                            <table class="table table-invoice my-custom-scrollbar table-wrapper-scroll-y">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="field">As per calculation weight</th>
                    ...
                    foreach($toBePackedScanItems as $item){
                        if($item->is_packed !=1){
                            ...
                            $itemDetailOrder = DB::table('tbl_item_orders')->where('customer_id', @$itemOrders[0]->customer_id)
                        ...
                        $itemImages = get_item_default_img_item_id($item->item_id);
                            ...
                            if(@$itemDetailOrder->item_weight_in_kg != 0 && @$itemDetailOrder->set_of_in_weight != 0 && @$itemDetailOrder->price_per_kg != 0){
                                if($itemDetailOrder->pending_qty !=0){

                                    @$itemActualWeightKg = (@$itemDetailOrder->item_weight_in_kg * $itemDetailOrder->set_of_in_weight) * $itemDetail->pending_qty; 
                                }else{
                        
                                    @$itemActualWeightKg = (@$itemDetailOrder->item_weight_in_kg * $itemDetailOrder->set_of_in_weight) * $itemDetailOrder->quantity; 
                                }
                            }
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td class="value"> {{(@$itemActualWeightKg == 0) ? "":@$itemActualWeightKg}}</td>
                                        <!-- <td class="value"> {{@$item->item_invt_weight}}</td> -->
                                        <td class="value"> {{@$item->calculation_weight}}</td>
                                        
                                        <td class="value">
                                            <a href="javascript::void(0);"
                                                id="{{@$itemOrders[0]->order_id.'_'.$item->item_id.'_'.$item->customer_id.'_'.$item->id}}"
                                                onclick="deleteScandItem(this.id);" class="btn btn-danger" data-toggle="tooltip" data-container="body" data-title="Dalete"> <i class="fa fa-trash" aria-hidden="true"></i></a>
                                            
                                                <a href="javascript::void(0);"
                                                
                                                onclick="editItemToBePackedByItemId(this.id)" id="{{$item->item_id.'_'.@$item->id}}" class="btn btn-success pull-right" data-toggle="tooltip" data-container="body" data-title="Edit"> <i class="fa fa-edit" aria-hidden="true"></i></a>
                                        </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form id="checkedGetBarcodeByItemIdForm">
                            @csrf
                                <table class="table table-invoice">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="field">Item <input type="checkbox" id="ckbCheckAll"/></th>
                                            <th class="field">Item Name</th>
                            ...
                            <button type="button" class="btn btn-default" data-dismiss="modal" onclick="checkedGetBarcodeByItemId()">OK</button>
