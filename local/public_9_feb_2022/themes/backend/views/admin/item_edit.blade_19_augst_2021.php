                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price_per_kg" value="{{optional($item)->price_per_kg}}" class="form-control"  placeholder="price per kg">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="set_of" value="{{optional($item)->set_of}}" class="form-control"  placeholder="Set of">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control productAttribute" id="productAttribute" name="productAttributeID" placeholder="Please select attribute">
                                                ...
                                                // $catAttrChildArr = DB::table('tbl_item_category_child')->distinct('tbl_item_tags.item_id')([item_attr_id] => 4)->get();
