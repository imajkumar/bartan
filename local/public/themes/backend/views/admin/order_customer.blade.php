                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#cancelOrderModelByCustomer" id="{{$itemOrder->order_id.'_'.Auth::user()->id}}"  onclick="cancelOrderModelByCustomer(this.id);" class="btn btn-danger" data-toggle="modal" data-container="body" data-title="Cancel">Cancel</a>
                                             <!-- <a href="{{url('order-cancel-by-custumer/'. $itemOrder->order_id.'/'. Auth::user()->id)}}" onclick="return confirm('Do you really want to Cancel this order?');" class="btn btn-danger" data-toggle="tooltip" data-container="body" data-title="Cancel">Cancel</a> -->
                                            @endif
                                        </td>
