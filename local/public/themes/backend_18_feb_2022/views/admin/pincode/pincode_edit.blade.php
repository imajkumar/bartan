        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="tree-view-1">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" id="updatePincode" method="post" action="{{route('updatePincode', $pincode->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-8">
                                            <input type="text" name="pincode" id="pincode" value="{{@$pincode->pincode}}" class="form-control @error('pincode') is-invalid @enderror" placeholder="Pincode">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-8">
                                            <select class="form-control state" id="state_id" name="state_id">
                                                ...
                                                ?>
                                                    <option value="{{$stateDef->id}}" {{(@$pincode->state_id == $stateDef->id) ? "selected":""}}>{{ $stateDef->name }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-8">
                                            <select class="form-control city" id="city_id" name="city_id">
                                                ...
                                                ?>
                                                <option value="{{@$pincode->city_id}}" selected>{{@$city->name}}</option>
