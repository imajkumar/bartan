               ...
               <!--  <?php
                    ...
                    <div class="side-menu-wrapper">
                        <div class="profile-highlight">
                            ...
                            <a href="{{route('showCustomerLoginForm')}}">
                                ...
                                <span class="d-none d-xl-inline"><img src="{{asset('assets/img/icon/key.svg')}}" class="user-icon" alt=""> Login</span>
                            </a>
                        ...
                        <ul>
                            <li><a href="#" rel="nofollow"><img src="{{asset('assets/img/icon/information.svg')}}" class="user-icon" alt=""> Information</a></li>
                        ...
                        <li><a href="{{route('refundPolicy')}}" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/return.svg')}}" class="user-icon" alt=""> Refund policy</a></li>
                        <li><a href="{{route('privacyPolicy')}}" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/return.svg')}}" class="user-icon" alt=""> Privacy & Policy</a></li>
                        <li><a href="{{route('termsOfUse')}}" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/return.svg')}}" class="user-icon" alt=""> Terms of use</a></li>
                ...
                ?> -->
                    <div class="side-menu-wrapper">
                        ...
                        <img src="{{$profil_pic ?? ''}}" alt="profile-img" width="36" height="36">
                            <div class="details">
                            <div id="profile-name">{{ucfirst(Auth::user()->name)}}</div>
                            <div id="profile-footer">{{(@$customerdetail->customer_type == 1)? 'Dealer':((@$customerdetail->customer_type == 2)? 'Wholesaler':((@$customerdetail->customer_type == 3)? 'Distibuter':''))}}</div>
                            </div>
                        </div>
                        <a href="#" class="menu-close">×</a>
                        <ul>
                        ...
                        <li><a href="{{route('refundPolicy')}}" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/return.svg')}}" class="user-icon" alt=""> Refund policy</a></li>
                            ...
                            <li><a href="{{route('privacyPolicy')}}" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/return.svg')}}" class="user-icon" alt=""> Privacy & Policy</a></li>
                        <li><a href="{{route('termsOfUse')}}" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/return.svg')}}" class="user-icon" alt=""> Terms of use</a></li>
                            <!-- <li><a href="#" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/rupee.svg')}}" class="user-icon" alt=""> Rate Card</a></li> -->
                            <!-- <li><a href="#" target="_blank" rel="nofollow"><img src="{{asset('assets/img/icon/language.svg')}}" class="user-icon" alt=""> Language</a></li> -->
                            <li>

                                <a href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();" class="dropdown-item"><img src="{{asset('assets/img/icon/logout.svg')}}" class="user-icon" alt=""> Log Out</a>
                                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                    @csrf
                                </form>
                                <!-- <a href="{{ route('customerLogout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();" class="dropdown-item"><img src="{{asset('assets/img/icon/logout.svg')}}" class="user-icon" alt=""> Log Out</a>
