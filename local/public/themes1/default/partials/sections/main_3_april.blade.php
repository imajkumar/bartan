...
<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4">
				<a href="#">
				<img src="{{ asset('/assets/img/icon/airan-logo.jpg') }}" class="br-image mb-2">
			</a>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4">
				<a href="#">
				<img src="{{ asset('/assets/img/icon/ck-logo-2020.jpg') }}" class="br-image mb-2">
			</a>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4">
				<a href="#">
				<img src="{{ asset('/assets/img/icon/monet-logo.jpg') }}" class="br-image mb-2">
			</a>
			</div>
		</div>
	</div>
