  ...
  <div class="col-lg-6 mx-auto">
      <div class="checkout"> 
          <table class="table ptmtbl ">
            ...
            <tr>
              <td>Mobile</td>
              <td class="text-right">0000 0000 00</td>
            </tr>
            <tr>
              <td>Email ID</td>
              <td class="text-right">demo@demo.com</td>
            </tr>
            <tr>
              ...
              <td class="text-right"><strong>5000.00</strong></td>
                ...
                <td class="text-right">xxxxxx512</td>
      ...
      <div class="invoice-header">
        ...
        <div class="w-30">
          <div class="invoice-date"> 
            ...
            <div class="invoice-detail">Delivery at:</div>
          <strong class="text-inverse">{{$customerdetail->store_name}}</strong><br />
