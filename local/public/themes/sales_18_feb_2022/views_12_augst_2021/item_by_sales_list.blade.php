        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="tree-view-1">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        <a class="btn btn-success pull-right" href="{{route('itemMasterLayoutSales')}}"><i class="fas fa-lg fa-fw fa-plus-circle"></i> Add New</a>
                 <!--        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a> -->
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <!-- <td>
                                                @if($itemData->is_visible == 1)
                                                    ...
                                                    <a href="javascript:void();" id="{{$itemData->item_id}}" onclick="itemDeactiveSales(this.id);" class="btn btn-danger" data-toggle="tooltip" data-container="body" data-title="Deactive"><i class="far fa-lg fa-fw icon-user-unfollow"></i></a>
                                            
                                                @else
                                                
                                                    <a href="javascript:void();" id="{{$itemData->item_id}}" onclick="itemActiveSales(this.id);" class="btn btn-success" data-toggle="tooltip" data-container="body" data-title="Active"><i class="far fa-lg fa-fw icon-user-following"></i></a>

                                                @endif

                                                <a class="btn btn-default" href="{{route('itemEditLayoutSales',$itemData->item_id)}}" data-toggle="tooltip" data-container="body" data-title="Edit"><i class="far fa-lg fa-fw fa-edit"></i></a>
                                            </td> -->
                                        </tr>
