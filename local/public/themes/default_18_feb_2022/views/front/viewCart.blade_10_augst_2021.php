            ...
            <div class="checkout-footer">
               ...
               <?php }?>
                ...
                ?>
                    ...
                    <input type="text" name="merchant_id" value="{{ env('CCA_MERCHANT_ID') }}"> 
                    ...
                    <input type="hidden" name="cancel_url" value="{{url('/api/ccPaymentCancelResponce')}}p"> 
                    
                
                    <input type="hidden" name="billing_name" value="Ajay Kumar" class="form-field" Placeholder="Billing Name"> 
                    <input type="hidden" name="billing_address" value="Delhi-96" class="form-field" Placeholder="Billing Address">
                
                    
                    <input type="hidden" name="billing_state" value="Delhi" class="form-field" Placeholder="State"> 
                    <input type="hidden" name="billing_zip" value="110096" class="form-field" Placeholder="Zipcode">
                
                    
                    <input type="hidden" name="billing_country" value="India" class="form-field" Placeholder="Country">
                    <input type="hidden" name="billing_tel" value="7703886088" class="form-field" Placeholder="Phone">
                
                    <input type="hidden" name="billing_email" value="ajayit2020@gmail.com" class="form-field" Placeholder="Email">
