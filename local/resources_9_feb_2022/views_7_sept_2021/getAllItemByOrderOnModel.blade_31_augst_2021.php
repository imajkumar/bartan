...
?>
    <tr>
        ...
        ?>    <input type="checkbox" onclick="checkedGetBarcodeByItemId({{optional($item)->item_id}})" value="{{optional($item)->item_id}}" class="checkedGetBarcodeByItemId" name="checkedGetBarcodeByItemId"/>
