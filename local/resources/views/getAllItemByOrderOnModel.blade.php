...
?>
    ...
    <tr>
        ...
        <!-- <input type="hidden" id="{{optional($itemOrder)->itemOrederRowId}}" value="{{optional($itemOrder)->itemOrederRowId}}" name="itemOrderId[]"/> -->
        <input type="checkbox" id="{{optional($item)->item_id}}" value="{{optional($item)->item_id.'_'.optional($itemOrder)->itemOrederRowId}}" class="checkedGetBarcodeByItemId" name="checkedGetBarcodeByItemId[]"/>
        <!-- <input type="checkbox" id="{{optional($item)->item_id}}" value="{{optional($item)->item_id.'_'.optional($itemOrder)->itemOrederRowId.'_'.optional($itemOrder)->quantity}}" class="checkedGetBarcodeByItemId" name="checkedGetBarcodeByItemId[]"/> -->
