        ...
        <div class="product">
            ...
            <div class="product-detail">
                ...
                <div class="product-image">
                    ...
                    <meta property="og:title" content="{{ \Str::limit(strip_tags(@$item->product_name),25,'') }}"/>
                    <meta property="og:image" content="{{($defaultImg) ? $defaultImg:$itemImg}}"/>  
                    <meta property="og:description" content=""/>
                    <meta property="og:url" content="{{ route('productDetail', $item->slug) }}" />
                    <meta property="og:type" content="article" /> 
                    <meta property="og:site_name" content="Bartan"/>

                    <!-- END product-thumbnail -->
                    <!-- BEGIN product-main-image -->
                    <div class="product-main-image" data-id="main-image">
                        <img class="zoom_mw" src="{{($defaultImg) ? $defaultImg:$itemImg}}" data-zoom-image="{{($defaultImg) ? $defaultImg:$itemImg}}" alt="img" />
                    </div>
                ...
                <div class="product-info">
                    ...
                    <div class="product-info-header">
                        ...
                        <?php 
                         $fullURL=route('productDetail', $item->slug);
                        if($totalOff != 0){?>
                    ...
                    <a href=" https://web.whatsapp.com/send?text=<?php echo $fullURL;?>&title=<?php echo $item->product_name; ?>&source=<?php echo url('/'); ?>" rel="noopener" target="_blank" class="whatapp-share-button btn pull-right" >
                            
                            <i class="share_twitter fab fa-whatsapp"></i> Share</a>
                    </div>
