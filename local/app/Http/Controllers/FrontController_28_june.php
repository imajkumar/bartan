...
class FrontController extends Controller
{
                ...
                $html = '<div class="item-row">';
                    ...
                    foreach($items as $item){
                        ...
                        if($totalOff == 0){
                            ...
                            '<div class="item-discount-price itm-dpr">MRP ₹'.$item->regular_price.'</div>';
                        }
    ...
    public function getItemsByCatId($catId)
    {
        ...
        $items = get_itemsByCatOrBrandId($flag='Category', $limit=-1, $catId, $page='', $brandId);
        // pr($items);
    ...
    public function getItemsByBrandId($BrandId)
    {
        ...
        if(!empty($CustomerWiseBrand)){

            $brands = get_itemsByCatOrBrandId($flag='Brand', $limit=-1, $BrandId, $page='');
        }else{
            $brands = array();
            //return $theme->scope('productsByBrandNotForYou', compact('brands', 'brandDetail'))->render();
