                        ...
                        <tbody>
                           ...
                           //pr($cartCollection );
                            ...
                            foreach ($cartCollection->toArray() as $key => $rowData) {
                                ...
                                $productArr = DB::table('tbl_items')->where('item_id', $rowData['id'])->select('invt_saleunit','is_tax_included', 'cat_id','regular_price', 'item_invt_min_order','item_cart_remarks', 'is_visible')->first();
