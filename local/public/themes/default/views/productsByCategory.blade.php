...
<div id="page-header" class="section-container page-header-container bg-black">
    ...
    <!-- BEGIN container -->
    <div class="container">
    <h1 class="page-header"><b>{{(@$category->item_name)? @$category->item_name:@$keyword}}</b></h1>
    </div>
    <!-- END container -->
</div>
<!-- BEGIN #page-header -->
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row row-space-0">
                            ...
                            <div class="col-md-5">
                                <input type="number" class="form-control input-sm checckPrice" name="priceTo" id="priceTo" value="{{@$priceTo}}" placeholder="Price To" />
                            </div>
                        </div>
                    </div>
