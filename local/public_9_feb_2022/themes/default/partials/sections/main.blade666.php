...
<div id="mobile-list" class="section-container p-t-0">
	...
	<div class="container">
		<div class="category-container">
			...
			<div class="category-sidebar">
				<ul class="category-list category-list border-all height-fix">
					...
					if($group){
					?>
						<li><a id="{{'Category_'.$itemCategory->id}}" class="getItem1" onclick="paginationCategoy(flag='Category', catId = {{$itemCategory->id}}, pageNo='', perPageLimit={{$per_page_limit}})" href="javascript:void(0);">{{ucfirst(@$group->g_name)}}</a></li>
		...
		<div class="content_detail__pagination cdp" actpage="1" id="paginateHtml">
			<!-- <a href="#!-1" class="cdp_i" onclick="paginationCategoy(flag='Category', catId = '', pageNo={{5-1}}, perPageLimit={{$per_page_limit}})">prev</a> -->
			<a href="#!-1" class="cdp_i">prev</a>
			<?php
			for($p=1; $p<=$totalPage; $p++){ ?>

				<!-- <a class="cdp_i" href="#!{{$p}}" onclick="paginationCategoy(flag='Category', catId = '', pageNo={{$p}}, perPageLimit={{$per_page_limit}})">{{$p}}</a> -->
			...
			<!-- <ul class="pagination justify-content-center m-t-0" id="paginateHtml"> -->
				...
				<li class="page-item" onclick="paginationCategoy(flag='Category', catId = '', pageNo={{$p}}, perPageLimit={{$per_page_limit}})"><a class="page-link" href="javascript:;">{{$p}}</a></li>
