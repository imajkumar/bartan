                        ...
                        <tbody>
                           ...
                           //pr($cartCollection );
                            ...
                            foreach ($cartCollection->toArray() as $key => $rowData) {
                                ...
                                $productArr = DB::table('tbl_items')->where('item_id', $rowData['id'])->select('invt_saleunit','is_tax_included', 'cat_id','regular_price', 'item_invt_min_order')->first();
                                ...
                                <td class="cart-summary" colspan="12">
                                    <div class="summary-container">
                                        ...
                                        <div class="summary-row total">
                                            <div class="field">Grand Total <a href="#" class="m-l-5 text-muted" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Order for minimum Rs.3000 (exclude packing and delivery charges).">
