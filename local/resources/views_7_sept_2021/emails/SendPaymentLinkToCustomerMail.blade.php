...
$paymnt =  DB::table('tbl_payment_status')->where('item_order_id',  $orderId)
                        ->first();
...
<p style="font-size: 16px; margin: 15px 0px 10px 0px;">Thank you for shopping with us. We'd like to let you know that Subhiksh has received your order, and is preparing it for shipment at below address.</p>
<p style="font-size: 16px; margin: 15px 0px 10px 0px;"> <address class="m-t-5 m-b-5">
                    ...
                    PAYMENT LINK:       <a href="{{@$paymnt->payment_link}}" target="_blank">PAYNOW</a><br />
