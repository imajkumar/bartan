...
@endif
			...
			<div class="col-md-6">
				...
				<div><b>Email</b></div>
				<p class="m-b-15">
					<i class="fa fa-envelope"></i> <a href="mailto:info@bartan.com" class="text-inverse">info@bartan.com</a><br>

				</p>
				<div><b>Mobile</b></div>
				<p class="m-b-15">
					<i class="fa fa-mobile xxxlarge"></i> <a href="tel:+91-9821067414" class="text-inverse">+91-9821067414</a><br>
