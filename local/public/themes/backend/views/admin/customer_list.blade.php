        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <?php
                    $customerMinimumOredrVal = DB::table('tbl_customers')->where('minimum_order', '!=', '')->first();
                    ?>
                    <a id="{{@$customerMinimumOredrVal->minimum_order}}" onclick="setMinimumOrderForAllCustomer(this.id)" href="#setMinimumOrderForAllCustomerModel" class="btn btn-success" data-toggle="modal" data-toggle="tooltip" data-container="body" data-title="Minimum Oredr"><i class="fa fa-plus" aria-hidden="true"></i> Set Minimum  Order</a>
                    <a class="btn btn-success pull-right" href="{{route('exportCustomer')}}"><i class="fas fa-lg fa-fw fa-download"></i> Export Customer</a>
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Customer registration date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$customer->id}}</td>
                                        <td>{{ucfirst(@$customerShop->store_name)}}</td>
...
{{-- start model Minimum order value for all customers--}}
<div class="modal fade" id="setMinimumOrderForAllCustomerModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <form action="{{route('setMinimumOrderForAllCustomer')}}" id="setMinimumOrderForAllCustomer" method="post">
       
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Minimum order value for all customers</h4>
                ...
                <div class="modal-body">
                       ...
                       <input type="text" name="minimum_order" id="minimum_order" class="form-control" placeholder="Minimum order value for all customers"/>

                       
                   
                </div>
                <div class="modal-footer">
                    <button type="submit" id="setMinimumOrderForAllCustomerBtn" class="btn btn-primary"> Save</button>
...
{{-- end Minimum order value for all customers --}} 
