    ...
    <div class="col-xl-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="tree-view-1">
        <div class="panel-heading">
          ...
          <a href="{{route('createUser')}}" class="btn btn-success" data-title="Add user"><i class="fa fa-plus" aria-hidden="true"></i> Add User</a>
          ...
          <div class="tab-content">
            ...
            <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
              ...
              <tbody>
                ...
                $usersArr = DB::table('users')->whereNotNull('name')->where('user_type', 1)->where('id', '!=', 5)->orderBy('id','asc')->get();
