        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="tree-view-1">
                <div class="panel-heading">
                    ...
                    <a class="btn btn-success pull-right" href="{{route('exportItemOrder')}}"><i class="fas fa-lg fa-fw fa-download"></i> Export Order</a>
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{date("d-m-Y h:i a", strtoTime($itemOrder->created_at))}}
                                        </td>
                                       ...
                                       <?php }else{ ?>
                                        <td>
                                            ...
                                            <span class="badge badge-md btn-danger">Cancel  {{(!empty($itemOrder->cancel_reason)) ? 'Reason: '.$itemOrder->cancel_reason:''}}</span>
                                        ...
                                        <td>
                                            ...
                                            <?php }else {?>
                                                @if($itemOrder->stage == 0 || $itemOrder->stage == 5)
                                            ...
                                            @if($itemOrder->stage != 4 && $itemOrder->stage != 6) 
                                            <!-- <a href="#cancelOrderModelByCustomer" id="{{$itemOrder->order_id.'_'.Auth::user()->id}}"  onclick="cancelOrderModelByCustomer(this.id);" class="btn btn-danger" data-toggle="modal" data-container="body" data-title="Cancel">Cancel</a> -->
                                            <a href="#cancelOrderModel" id="{{$itemOrder->order_id.'_'.Auth::user()->id}}"  onclick="cancelOrder(this.id);" class="btn btn-danger" data-toggle="modal" data-container="body" data-title="Cancel">Cancel</a>
