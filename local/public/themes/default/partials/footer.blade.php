    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
               ...
               <!--  <li><i class="fa fa-li fa-angle-right"></i> <a href="#">Shopping Help</a></li> -->
                    ...
                    <li><i class="fa fa-li fa-angle-right"></i> <a href="{{route('contactUs')}}">Contact Us</a></li>
                      ...
                      <li><i class="fa fa-li fa-angle-right"></i> <a href="{{route('login')}}" target="_black">Team login</a></li>
                        <li><i class="fa fa-li fa-angle-right"></i> <a href="{{route('salesLoginLayout')}}" target="_black">Sales Team login</a></li>
                        ...
                        <li>
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    @if($item->item_mrp)
									<div class="price del-footer" style="margin-top: -24px;margin-left: 44px;"><del>₹{{($item->item_mrp)? $item->item_mrp:''}}</del></div>
									@endif
                                ...
                                @if($item->item_mrp)
                                <div class="price del-footer" style="margin-top: -24px;margin-left: 44px;"><del>₹{{($item->item_mrp)? $item->item_mrp:0}}</del></div>
                                @endif

                                <!-- <div class="price del-footer" style="margin-top: -24px;margin-left: 44px;"><del>₹{{($item->regular_price)? $item->regular_price:0}}</del></div> -->
                                <?php }?>
            ...
            <div class="col-lg-3">
                ...
                <abbr title="Phone">Mobile:</abbr> +91-9821067414<br />
                <!-- <abbr title="Phone">Phone:</abbr> +91-9311048811<br /> -->
               
                <abbr title="Email">Email:</abbr> <a href="mailto:info@bartan.com">info@bartan.com</a><br />
