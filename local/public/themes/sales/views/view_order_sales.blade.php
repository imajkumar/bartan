...
<div id="content" class="content">
    ...
    <div class="invoice-company">
        ...
        <div class="col-lg-12 pull-right">
             ...
             <span class="pull-right hidden-print">
                <a href="javascript:;" id="downViewCart" onclick="getPDF()" class="btn btn-sm btn-white m-b-10 textHideInPdf"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Export as PDF</a>
    ...
    <div class="invoice-header">
        ...
        <div class="invoice-header">
            ...
            <div class="invoice-to">
            <!-- <strong class="text-inverse">Billed to</strong></br> -->
                <address class="m-t-5 m-b-5">
                      <div class="break"> 
                <strong class="text-inverse">{{$customerdetail->store_name}}</strong></div>
            ...
            <div class="invoice-to">
                ...
                <strong class="text-inverse">Delivey at</strong>
            <address class="m-t-5 m-b-5">
          <strong class="text-inverse">{{$customerdetail->store_name}}</strong><br />
          Street Address: {{$customerdetail->business_street_address}}<br />
          Country:        {{$country->name}}, 
          State:          {{$state->name}}, 
          City:           {{$city->name}}<br/>
          ...
          {{-- Fax: (123) 456-7890 --}}
                ...
                <div class="invoice-detail textHideInPdf">
                <!-- Order no: {{$itemOrders[0]->order_id}}<br /> -->
