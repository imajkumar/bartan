                ...
                <input type="hidden" name="attribute_id" value="{{$attribute->id}}"/>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4 col-sm-8">
                                ...
                                <div class="form-group row m-b-15" Id="attrOption" style="display:{{(count($attributeOptions)>0 && (($attribute->type=='select') || ($attribute->type=='multiselect') || ($attribute->type=='checkbox')))? 'block':'none'}}">
