...
<!-- 
            ...
            <div class="checkout-footer">
               ...
               <?php }else{?>
                ...
                <button type="submit" id="processOrder" class="btn btn-inverse btn-md width-200"><span id="loadSpin" style="display:none"><i class="fas fa-spinner fa-pulse"></i></span>Submit Order</button>
               <?php }?>
