...
<?php
        if(Auth::user()){
            ...
            if(Auth::user()->user_type ==0){
                ...
                $customerBusinessDetail = get_customer_and_address_by__user_id(Auth::user()->id);
...
-->
                    ...
                    <div class=" collapse navbar-collapse" id="navbar-collapse">
                        <ul class="nav">
                            ...
                            <li class="dropdown  dropdown-full-width dropdown-hover">
                                <a href="#" class="tglelnk"  data-toggle="dropdown">
                                    <i class="fas fa-store"></i> <strong>Our Store</strong>
                                    <b class="caret"></b>
                                    <span class="arrow top"></span>
                                    <span class="cn-dgn">{{@$customerBusinessDetail->store_name}}</span>
                                </a>
                                <!-- BEGIN dropdown-menu -->
            ...
            <li class="" style="width: 480px;">
                <form style="margin-top:20px"  class="hdrsrch" action="{{route('searchKeyword')}}" method="get" id="searchForm" name="searchForm">
    ...
    <div class="header-nav">
        <ul class="nav pull-right">
            ...
            ?>
            <li class="dropdown dropdown-hover" id="cartAppendHtml">
                            ...
                            ?>
                                <li>
                                    ...
                                    <div class="cart-item-close">
                                        <a href="javascript:void(0)" onclick="removeItemFromCart({{$rowData['id']}})" data-toggle="tooltip" data-title="">&times;</a>
                                    </div>
                                </li>
...
<!--mb Serch--->
<div class="brtn-srch">
    <form   action="{{route('searchKeyword')}}" method="get" id="searchForm" name="searchForm">
        <div class="input-group">
            <input type="text" name="keyword" placeholder="Search" class="form-control bg-silver-lighter" />
                <div class="input-group-append">
                    <button class="btn btn-inverse" type="submit"><i class="fa fa-search"></i></button>
