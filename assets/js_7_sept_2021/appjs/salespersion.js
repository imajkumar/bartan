...
//Start filter search
$('#salesItemByBrand_old').on('change', function(e) {
    e.preventDefault();
...
$('#salesItemByCategory_old').on('change', function(e) {
    e.preventDefault();
...
function searchItemBySales() {
    ...
    let catId = $("#salesItemByCategory").val();
    let brandId = $("#salesItemByBrand").val();
    ...
    $.ajax({
        ...
        success: function(responce) {
            ...
            if (responce['success'] == true) {
                ...
                $('#salesItemAppend').empty().append('<div class="item-nofound item-row"><h4><i class="fas fa-shopping-basket"></i>Item not found</h4></div>');
...
function searchItemBySales_old() {
