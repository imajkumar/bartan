        ...
        <div class="col-xl-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="default-tab-1">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                   ...
                                   $getCustomerShop = DB::table('tbl_businesses')->select('store_name')->where('customer_id', $customer->id)->first();
                                   ?>
                                   <option value="{{$customer->user_id}}">{{ucfirst(@$getCustomerShop->store_name).'-'.$customerType.'-'.$customer->phone.'-'.$customer->email}}</option>
                    ...
                    <table id="" class="data-table-without-resp table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        <th width="1%">Id</th>
                                ...
                                <?php
                                    ...
                                    foreach($customerSaleses as $customerSale){
                                        ...
                                        //echo "<pre>"; print_r($customerShop);exit;
                                        ...
                                        $customerType = "";
                                            ...
                                            }else if (@$customerDetail->customer_type == 3) {
                                            ...
                                            @$Name = ucfirst(@$customerDetail->cutomer_fname.' '.@$customerDetail->cutomer_lname);
                                            //echo @$Name;
                                            //$customerName = @$Name.'-'.@$customerType.'-'.@$customerDetail->phone.'-'.@$customerDetail->email;
